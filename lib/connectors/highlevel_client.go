...
func (c *highLevelClient) ValidateConnectorConfig(req ValidateConnectorConfigRequest) (ValidateConnectorConfigResponse, error) {
	return c.client.ValidateConnectorConfig(req)
}
